...
if(is_array($tmparr['data'])){
  foreach( $tmparr['data'] as $key => $value ){
   if($value -> id == $pid){
    $output['title']= $value -> title;
    $output['imageUrls']= $value -> imageUrls;
    $output['marketPrice']= $value -> marketPrice;
    $output['subtitle']= $value -> subtitle;
   }
  }
}

$count = count($output['imageUrls'])
?>
<!DOCTYPE html>
<html>
<head lang="en">
        ...
        <div class="show_pic">
          <div class="lg_pic">
            <div class="box">
              ...
              <img src=<?php echo $output['imageUrls'][$count-1]?> alt=""/>
            </div>
            <div class="show_big">
              <img src=<?php echo $output['imageUrls'][$count-1]?> alt=""/>
            </div>
          ...
          <div class="sm_pic">
            <div>
              <ul>
                <li class="active"><img src=<?php echo $output['imageUrls'][$count-2]?> _src=<?php echo $output['imageUrls'][$count-2]?> alt=""/></li>
                <li><img src=<?php echo $output['imageUrls'][$count-3]?> _src=<?php echo $output['imageUrls'][$count-3]?> alt=""/></li>
                <li><img src=<?php echo $output['imageUrls'][$count-4]?> _src=<?php echo $output['imageUrls'][$count-4]?> alt=""/></li>
                <li><img src=<?php echo $output['imageUrls'][$count-5]?> _src=<?php echo $output['imageUrls'][$count-5]?> alt=""/></li>
                <li><img src=<?php echo $output['imageUrls'][$count-6]?> _src=<?php echo $output['imageUrls'][$count-6]?> alt=""/></li>
              </ul>
            </div>
          </div>
        </div>
        <div class="show_info" ref=<?php echo "$pid"?>>
          <h3 class="info_hd"><?php echo "$output[title]"?></h3>
          <div class="summary">
            <div class="summary_price">
              <div class="dt">慕课价</div>
              <div class="dd price"><?php echo "$output[marketPrice]"?></div>
            </div>
         ...
         <!--产品介绍、商品评价选项卡-->
          ...
          <div class="item_detail_info">
            <div class="item_banner_pic">
              <a href="javascript:;"><img src=<?php echo $output['imageUrls'][0]?> alt=""/></a>
            </div>
            <!--强烈推荐-->
            ...
            <div class="item_details_pic">
              ...
              <div class="pic">
                <img src=<?php echo $output['imageUrls'][1]?> alt=""/>
                <img src=<?php echo $output['imageUrls'][2]?> alt=""/>
                <img src=<?php echo $output['imageUrls'][3]?> alt=""/>
                <img src=<?php echo $output['imageUrls'][4]?> alt=""/>
              </div>
            </div>
          </div>
          <!--商品评价-->
